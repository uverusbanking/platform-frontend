...
const resolver = zodResolver(FormSchema) as Resolver<PreviewFormValues>;
type PreviewFormValues = Pick<
  ICustomerData,
  | "firstName"
  | "middleName"
  | "lastName"
...
export function PreviewSteps({ data, nextStep, prevStep }: Props) {
  ...
  const {
    ...
    resolver,
    mode: "onChange",
    defaultValues: data as PreviewFormValues,
  });
  ...
  useEffect(() => {
    if (data) {
      ...
      setValue("gender", data.gender as PreviewFormValues["gender"], {
        shouldValidate: true,
        shouldDirty: true,
        shouldTouch: true,
      });
  ...
  const onSubmit = async (formData: PreviewFormValues) => {
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={data?.gender as PreviewFormValues["gender"]}
                onValueChange={(value) =>
                  setValue("gender", value as PreviewFormValues["gender"])
                }
                disabled
              >
                <SelectTrigger>
