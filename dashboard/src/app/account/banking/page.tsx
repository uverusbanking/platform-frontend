...
const EBanking = () => {
  const [activeTab, setActiveTab] = useState("wallet-transfer");
        ...
        <TabsContent value="bank-transfer">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Transfer from branch settlement account to banks
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Select>
                    ...
                    <SelectContent>
                      <SelectItem value="main">
                        Main Settlement - ₦5,000,000
                      </SelectItem>
                      <SelectItem value="lagos">
                        Lagos Branch - ₦2,000,000
                      </SelectItem>
                      <SelectItem value="abuja">
                        Abuja Branch - ₦3,000,000
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input id="transfer-fee" type="number" value="50" readOnly />
                </div>
              </div>
              <Button onClick={() => handleTransfer("Bank")} className="w-full">
