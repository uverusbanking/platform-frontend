...
export interface CompanyData {
  ...
  documents: {
    CAC_CERTIFICATE?: documentInterface;
    MEMORANDUM?: documentInterface;
    BOARD_RESOLUTION?: documentInterface;
    PROOF_OF_ADDRESS?: documentInterface;
    UBO_DECLARATION?: documentInterface;
  };
}
...
export default function CompanyRegistration() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // console.log("Submitting KYB application:", companyData);
      const response = await registerCompany(
        companyData as unknown as ICompanyRegistrationPayload,
      );
      // console.log(response);

      const responseData = response.data as { id: string };
      setApplicationReference(responseData.id);
      ...
      console.log(error);
      const message = getApiErrorMessage(error, "Oops, something went wrong");
      setApiResponse({
        display: true,
        status: false,
        message,
      ...
      <div className="min-h-screen bg-gradient-surface flex items-center justify-center p-6">
        <Card className="max-w-md w-full">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Your company registration application has been submitted
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Complete the Know Your Business process to register your company
          </p>
        </div>
