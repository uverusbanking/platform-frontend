...
import { useGetApiKeys } from "@/hooks/queries/useOrganisationQueries";
import {
  useAddApiKey,
  useDeleteApiKey,
...
export function DevelopersTab() {
  ...
  return (
    <Card className="border-none bg-surface/60 backdrop-blur-xl relative overflow-hidden group">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground max-w-[280px]">
                ...
                <span className="font-semibold text-primary">
                  {(userData.view_mode || "LIVE").toLowerCase()}
                </span>{" "}
                environment.
              </p>
            </div>
