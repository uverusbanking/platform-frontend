...
import { directorInterface } from "@/types/organisationRegistration";
...
export function DirectorsStep({
  ...
  const onSubmit = async (formData: z.infer<typeof FormSchema>) => {
    ...
    onChange({ ...data, directors: [...directors, director] });
    reset();
  };
  ...
  const handleEditBtn = (bvn: string) => {
    ...
    if (director) {
      ...
      setValue("zipCode", director.zipCode || undefined);
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="text"
                  placeholder="Full registered organisation address"
