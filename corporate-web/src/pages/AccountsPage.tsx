...
const accounts: Account[] = [
  {
    ...
    type: "current",
    currency: "NGN",
    balance: 84_520_300.57,
    pendingOutflows: 2_150_000,
    thisMonth: 12_340_000,
    burn: "3.2%",
    bankName: "Wema Bank",
    accountName: "Dangote Industries Ltd",
    accountAlias: "Main Operating Account",
    accountNumber: "8962413577",
    chartData: [
      { date: "26 Mar", balance: 82_000_000 },
      { date: "27 Mar", balance: 83_100_000 },
      { date: "28 Mar", balance: 81_500_000 },
      { date: "29 Mar", balance: 84_200_000 },
      { date: "30 Mar", balance: 84_000_000 },
      { date: "31 Mar", balance: 84_520_000 },
    ...
    transactions: [
      {
        id: "t1",
        date: "Apr 01, 2026",
        counterparty: "NNPC – Rev/Cot",
        memo: "Mar 2026 gas supply payment",
        source: "Main Operating",
        amount: 45_200_000,
      },
      {
        id: "t2",
        date: "Mar 31, 2026",
        counterparty: "Flour Mills Nig.",
        memo: "Cement raw material Q1",
        source: "Main Operating",
        amount: -18_500_000,
      },
      {
      ...
      },
      {
        id: "t4",
        date: "Mar 25, 2026",
        counterparty: "Sterling-Craft Tech",
        memo: "Feb 2026 service charge",
        source: "Main Operating",
        amount: -1_006.2,
      },
      {
        id: "t5",
        date: "Mar 22, 2026",
        counterparty: "BUA Cement",
        memo: "Logistics settlement",
        source: "Main Operating",
        amount: 12_750_000,
      },
    ],
  },
  {
    ...
    currency: "NGN",
    balance: 15_230_400,
    pendingOutflows: 14_800_000,
    thisMonth: 14_800_000,
    burn: "97%",
    bankName: "Wema Bank",
    accountName: "Dangote Industries Ltd – Payroll",
    accountAlias: "Payroll Account",
    accountNumber: "8962413590",
    chartData: [
      { date: "26 Mar", balance: 30_000_000 },
      { date: "27 Mar", balance: 30_000_000 },
      { date: "28 Mar", balance: 29_500_000 },
      { date: "29 Mar", balance: 15_400_000 },
      { date: "30 Mar", balance: 15_300_000 },
      { date: "31 Mar", balance: 15_230_400 },
    ...
    transactions: [
      {
        ...
        memo: "Mar 2026 salaries – 842 staff",
        source: "Payroll",
        amount: -14_500_000,
      },
      {
      ...
      },
      {
        id: "t8",
        date: "Mar 01, 2026",
        counterparty: "Main Operating",
        memo: "Payroll funding Mar 2026",
        source: "Payroll",
        amount: 30_000_000,
      },
    ],
  },
  {
    ...
    burn: "0%",
    bankName: "Wema Bank",
    accountName: "Dangote Industries Ltd – DOM",
    accountAlias: "USD Domiciliary",
    accountNumber: "8962413601",
    chartData: [
      { date: "26 Mar", balance: 125_800 },
      { date: "27 Mar", balance: 125_800 },
      { date: "28 Mar", balance: 125_800 },
      { date: "29 Mar", balance: 125_800 },
      { date: "30 Mar", balance: 125_800 },
      { date: "31 Mar", balance: 125_800 },
    ...
    transactions: [
      {
        ...
        memo: "Turbine parts – PO #4421",
        source: "USD Domiciliary",
        amount: -42_500,
      },
      {
        id: "t10",
        date: "Jan 20, 2026",
        counterparty: "Shell Petroleum",
        memo: "Q4 2025 export proceeds",
        source: "USD Domiciliary",
        amount: 168_300,
      },
    ],
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        {accounts.map((acc) => (
          <div
            key={acc.id}
            className="rounded-2xl p-4 cursor-pointer transition-all shadow-card"
            style={{
              background:
                acc.id === selectedId
                  ? "rgb(var(--foreground))"
          ...
          >
            <div className="flex items-center justify-between mb-1">
              <span
                ...
                style={{
                  color:
                    acc.id === selectedId ? "#fff" : "rgb(var(--foreground))",
                }}
              >
                {acc.name}
              </span>
      ...
      <div className="flex items-center gap-3">
        <span
          className="text-xs px-2.5 py-1 rounded-pill font-semibold"
          style={{
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        {[
          ...
          },
          {
            ...
            value: fmt(account.pendingOutflows, account.currency),
          },
          {
            label: "This Month",
            value: fmt(account.thisMonth, account.currency),
          },
          { label: "Burn Rate", value: account.burn },
        ].map((s) => (
          <div
            key={s.label}
          ...
          >
            ...
            <p
              className="text-base sm:text-xl font-bold num mt-0.5 truncate"
              style={{
                fontFamily: "Manrope, sans-serif",
                color: "rgb(var(--foreground))",
              }}
            ...
            <div className="h-40 sm:h-48 mt-4">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={account.chartData}>
                  ...
                  <YAxis hide />
                  <Tooltip
                    formatter={(v: number) => fmt(v, account.currency)}
                  />
                  <Line
                    type="monotone"
                    dataKey="balance"
            ...
            filteredTx.map((tx) => (
              <Card key={tx.id} className="p-4 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-sm font-medium ${tx.amount < 0 ? "text-destructive" : "text-emerald-600"}`}
                  >
                    {tx.amount < 0 ? "- " : ""}
                ...
                {filteredTx.length === 0 ? (
                  ...
                  filteredTx.map((tx) => (
                    <TableRow key={tx.id}>
                      ...
                      <TableCell
                        className={`text-sm text-right font-medium whitespace-nowrap ${tx.amount < 0 ? "text-destructive" : "text-emerald-600"}`}
                      >
                        {tx.amount < 0 ? "- " : ""}
                        {fmt(tx.amount, account.currency)}
                      </TableCell>
